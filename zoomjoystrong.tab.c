...
static const char *const yytname[] =
{
  ...
  "command_list", "command", "point", "line", "circle", "rectangle",
...
#line 55 "zoomjoystrong.y" /* yacc.c:1646  */
    {printf("Drawing point at: (%d,%d)...", (yyvsp[-2].i), (yyvsp[-1].i));
	drawPoint((yyvsp[-2].i),(yyvsp[-1].i));}
#line 1238 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 59 "zoomjoystrong.y" /* yacc.c:1646  */
    {printf("Drawing line from (%d,%d) to (%d,%d)...",  (yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));
	drawLine((yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));}
#line 1245 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 63 "zoomjoystrong.y" /* yacc.c:1646  */
    {printf("Drawing circle drawn at (%d,%d) with radius of %d...", (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));
	drawCircle((yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));}
#line 1252 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 67 "zoomjoystrong.y" /* yacc.c:1646  */
    {printf("Drawing rectangle at (%d,%d) with width %d and height %d...", (yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i)); 
	drawRectangle((yyvsp[-4].i), (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i)); }
#line 1259 "zoomjoystrong.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 71 "zoomjoystrong.y" /* yacc.c:1646  */
    {printf("Changing color to %d %d %d...", (yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i)); 
	changeColor((yyvsp[-3].i), (yyvsp[-2].i), (yyvsp[-1].i));}
